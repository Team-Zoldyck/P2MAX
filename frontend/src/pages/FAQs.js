...
const FAQSData = [
  ...
  },
  {
    ...
    description:
      "P2Max is present in 19 countries in Africa. We are looking to further increase our reach and influence as we grow.",
  },
  {
      ...
      <section className="mt-20 w-[max-content] mx-auto flex flex-col items-center text-center">
        <div className="flex items-center justify-center">
          <svg
            ...
            className="ml-[-6rem] mr-[4.5rem] w-[2.5rem] h-[2.5rem]"
          >
            <circle r="6" transform="matrix(-1 0 0 1 29 24)" fill="#D9F8E0" />
            <ellipse
              rx="10.5"
              ry="10"
              transform="matrix(-1 0 0 1 10.5 10)"
              fill="#F3E0FF"
            />
          </svg>

          <h1 className="text-matic text-3xl font-bold">
        ...
        <form>
          <div className="bg-subtle mt-10 w-[32rem] h-[3rem] flex items-center px-10 rounded-lg">
            ...
            <input
              type="search"
              className="w-[32rem] h-[3rem] outline-none bg-subtle"
        ...
        <div className="mt-[8rem] mb-12 rounded-xl px-12 py-5 mx-auto bg-subtle w-[max-content] text-left text-matic">
          ...
          <div className="p-4 bg-[#CDD7E5] mt-5 flex rounded-lg">
            <input
              ...
              className="rounded-l-lg h-[2.5rem] w-[80%] px-4 outline-none"
            />
            <button className="w-[20%] bg-secondary rounded-lg text-white ml-[-.3rem]">
              opt in
            </button>
          </div>
        </div>
